defmodule InfinityOnePages.Github.Server do
  @moduledoc """
  ...
  * {:error, :timeout}
  ...
  Returns either a `%InfinityOnePages.Schema.Version{}` schema or nil.
  """
  def get_last do
  ...
  def init(_) do
    timeout = Application.get_env(:infinity_one_pages, :github_poll_timer, @default_poll_timeout)
